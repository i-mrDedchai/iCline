...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	...
	return {
		...
		// iCline-specific
		sakanaModelId: mode === "plan" ? apiConfiguration.planModeSakanaModelId : apiConfiguration.actModeSakanaModelId,
		janModelId: mode === "plan" ? apiConfiguration.planModeJanModelId : apiConfiguration.actModeJanModelId,
		zenmuxModelId: mode === "plan" ? apiConfiguration.planModeZenmuxModelId : apiConfiguration.actModeZenmuxModelId,
		sakanaModelInfo: mode === "plan" ? apiConfiguration.planModeSakanaModelInfo : apiConfiguration.actModeSakanaModelInfo,
