...
<!-- icline:version -->
> 📦 **เวอร์ชันปัจจุบัน:** `0.1.18-dev.4` · [Releases](https://github.com/i-mrDedchai/iCline/releases) · [Changelog](https://github.com/i-mrDedchai/iCline/blob/main/apps/vscode/CHANGELOG.md) · [Repo](https://github.com/i-mrDedchai/iCline)
<!-- /icline:version -->
...
```bash
code --install-extension i-mrdedchai.iCline-0.1.18-dev.4.vsix --force
```
