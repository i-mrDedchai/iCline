...
const PROVIDER_MODEL_ID_MAP: Record<string, { plan: keyof ApiConfiguration; act: keyof ApiConfiguration }> = {
	...
	// iCline-specific providers
	sakana: { plan: "planModeSakanaModelId", act: "actModeSakanaModelId" },
	jan: { plan: "planModeJanModelId", act: "actModeJanModelId" },
	zenmux: { plan: "planModeZenmuxModelId", act: "actModeZenmuxModelId" },
}
